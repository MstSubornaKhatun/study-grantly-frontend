...
const ScholarshipDetails = () => {
  ...
  return (
    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10 ">
      {" "}
      <div className="flex flex-col md:flex-row gap-8 items-start p-6 rounded-xl shadow-md bg-gray-50 dark:bg-gray-800">
        {" "}
        {/* Image */}{" "}
        <div className="md:w-1/2 rounded-xl overflow-hidden shadow-lg">
          {" "}
        ...
        {/* Details */}
        <div className="md:w-1/2 space-y-3">
          <h1 className="text-4xl font-extrabold text-[#640d14] dark:text-[#f4a261]">
            {scholarship.universityName}
          </h1>

          <span className="inline-block bg-[#640d14]/10 dark:bg-[#f4a261]/20 text-[#640d14] dark:text-[#f4a261] px-3 py-1 rounded-full text-sm font-medium">
            {scholarship.scholarshipCategory}
          </span>

          <p className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            <MapPin size={16} className="w-4 h-4 text-[#640d14] dark:text-[#f4a261]" />
            <strong>Location:</strong> {scholarship.universityCity},{" "}
            {scholarship.universityCountry}
          </p>

          <p className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            <BookOpen size={16} className="w-4 h-4 text-[#640d14] dark:text-[#f4a261]" />
            <strong>Subject:</strong> {scholarship.subjectCategory}
          </p>

          <p className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            <CalendarCheck size={16} className="w-4 h-4 text-[#640d14] dark:text-[#f4a261]" />
            <strong>Deadline:</strong> {scholarship.applicationDeadline}
          </p>
          ...
          {scholarship.description && (
            <p className="flex items-start gap-2 text-gray-700 dark:text-gray-300">
              <FileText
                size={16}
                className="w-4 h-4 text-[#640d14] dark:text-[#f4a261]"
          ...
          {scholarship.stipend && (
            <p className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
              <DollarSign size={16} className="w-4 h-4 text-[#640d14] dark:text-[#f4a261]" />
              <strong>Stipend:</strong> {scholarship.stipend}
            </p>
          )}

          <p className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            <CalendarDays size={16} className="w-4 h-4 text-[#640d14] dark:text-[#f4a261]" />
            <strong>Posted:</strong> {scholarship.postDate}
          </p>
          ...
          <p className="text-gray-700 dark:text-gray-300 flex items-center gap-2">
            <FileText size={16} className="w-4 h-4 text-[#640d14] dark:text-[#f4a261]" />
            <strong>Application Fee:</strong> ${scholarship.applicationFees}
          </p>

          <button
            onClick={handleApply}
            className="inline-block cursor-pointer mt-4 bg-[#640d14] hover:bg-[#500b10] dark:bg-[#f4a261] dark:hover:bg-[#e8935a] text-white px-6 py-3 rounded-lg shadow-md transition duration-300"
          >
            Apply for Scholarship
          </button>
        </div>
      ...
      {/* Review Section */}
      <div className="mt-16 bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow-md">
        ...
        {reviews.length === 0 ? (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {reviews.map((review) => (
              <div
                key={review._id}
                className="bg-white dark:bg-gray-700 shadow-sm p-5 rounded-xl border border-gray-100 dark:border-gray-600 hover:shadow-md transition duration-300"
              >
                <div className="flex items-center gap-4 mb-3">
                  <img
                    src={review.reviewerImage}
                ...
                <p className="text-sm text-gray-800 dark:text-gray-200 mb-2 flex items-center gap-1">
