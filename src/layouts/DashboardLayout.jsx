...
import { BookOpen, ClipboardList, Files, FileText, MessageSquare, PlusCircle, School, User, UserCircle, Users } from "lucide-react";
      ...
      <div className="drawer-side">
        ...
        <aside className="w-80 min-h-full bg-[#38040e] text-white flex flex-col py-6 px-4 shadow-2xl">
          ...
          <ul className="menu space-y-2 text-base">
            ...
            {/* moderator */}
            <li>
  <NavLink to="/dashboard/moderator-profile"  className={({ isActive }) =>
                  `px-4 py-2 rounded-lg transition duration-200 ${
                    isActive
                      ? "bg-white text-[#38040e] font-bold shadow"
                      : "hover:bg-[#640d14] hover:text-white"
...
<li>
  <NavLink to="/dashboard/manage-scholarships"  className={({ isActive }) =>
                  `px-4 py-2 rounded-lg transition duration-200 ${
                    isActive
                      ? "bg-white text-[#38040e] font-bold shadow"
                      : "hover:bg-[#640d14] hover:text-white"
...
<li>
  <NavLink to="/dashboard/all-reviews"  className={({ isActive }) =>
                  `px-4 py-2 rounded-lg transition duration-200 ${
                    isActive
                      ? "bg-white text-[#38040e] font-bold shadow"
                      : "hover:bg-[#640d14] hover:text-white"
...
<li>
  <NavLink to="/dashboard/all-applications"  className={({ isActive }) =>
                  `px-4 py-2 rounded-lg transition duration-200 ${
                    isActive
                      ? "bg-white text-[#38040e] font-bold shadow"
                      : "hover:bg-[#640d14] hover:text-white"
...
<li>
  <NavLink to="/dashboard/add-scholarship"  className={({ isActive }) =>
                  `px-4 py-2 rounded-lg transition duration-200 ${
                    isActive
                      ? "bg-white text-[#38040e] font-bold shadow"
                      : "hover:bg-[#640d14] hover:text-white"
...
<li>
  <NavLink to="/dashboard/manage-applications"  className={({ isActive }) =>
                  `px-4 py-2 rounded-lg transition duration-200 ${
                    isActive
                      ? "bg-white text-[#38040e] font-bold shadow"
                      : "hover:bg-[#640d14] hover:text-white"
